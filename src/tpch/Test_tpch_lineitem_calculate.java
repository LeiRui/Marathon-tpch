...
public class Test_tpch_lineitem_calculate {
...
//        RangeQuery q = new RangeQuery(6, 78044, 144242,true, true,
//        new double[]{3887245,178640,4160,6,29,91694.42,0.01,0.04});
//        H_ian h = new H_ian(totalRowNumber, ckn, CKdist,
//                q.qckn, q.qck_r1_abs, q.qck_r2_abs, q.r1_closed, q.r2_closed, q.qck_p_abs,
//                new int[]{6,1,7,5,8,4,3,2});
//        double tmpCost = h.calculate(100, 2.861, 21029.78506,
